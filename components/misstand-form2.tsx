...
const typeOptions = [
  ...
  { id: "machtsmisbruik", label: "Machtsmisbruik" },
  { id: "intimidatie", label: "Intimidatie/bedreiging" },
  { id: "bureaucratie", label: "Bureaucratische muur/onbereikbaarheid" },
  { id: "verlies-menselijkheid", label: "Gebrek aan menselijkheid" },
  { id: "geen-transparantie", label: "Gebrekkige informatievoorziening" },
  { id: "slechte-communicatie", label: "Slechte/foutieve communicatie" },
  { id: "wachttijden", label: "Lange/onnodige wachttijden" },
  { id: "onjuiste-dossiers", label: "Foutieve gegevens/dossiers" },
  { id: "financieel-onrecht", label: "Financiële uitbuiting/onterechte kosten" },
  { id: "geen-nazorg", label: "Geen of gebrekkige nazorg" },
  { id: "zorgfout", label: "Fout in zorg/medische behandeling" },
  { id: "geen-bezwaar", label: "Geen mogelijkheid tot bezwaar" },
  { id: "ongewenst-gedrag", label: "Seksueel grensoverschrijdend gedrag" },
  { id: "corruptie", label: "Corruptie/vriendjespolitiek" },
  { id: "privacy", label: "Privacy-schending/datalek" },
  { id: "onmenselijk", label: "Onmenselijke behandeling" },
  { id: "beperkte-toegang", label: "Beperkte toegang tot hulp" },
  { id: "onveiligheid", label: "Onveiligheid (fysiek/mentaal)" },
  { id: "systeemfalen", label: "Falende instantie of systeem" },
  { id: "misleiding", label: "Misleidende of onjuiste info" },
  { id: "verlies-autonomie", label: "Geen zeggenschap/autonomie" },
  { id: "uitsluiting", label: "Uitsluiting/marginalisering" },
  { id: "ongegronde-afwijzing", label: "Ongegronde afwijzing/sanctie" },
  { id: "bevooroordeeld", label: "Behandeling met vooroordelen" },
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>              
  <SelectItem value="bedrijven-en-werk">Bedrijven en Werk</SelectItem>
  <SelectItem value="dienstverlening">Dienstverlening</SelectItem>
  <SelectItem value="economie-en-werkgelegenheid">Economie en Werkgelegenheid</SelectItem>
  <SelectItem value="gezondheidszorg">Gezondheidszorg</SelectItem>
  <SelectItem value="justitie-en-wetgeving">Justitie en Wetgeving</SelectItem>
  <SelectItem value="klimaat-en-energie">Klimaat en Energie</SelectItem>
  <SelectItem value="milieu-en-duurzaamheid">Milieu en Duurzaamheid</SelectItem>
  <SelectItem value="onderwijs">Onderwijs</SelectItem>
  <SelectItem value="overheid">Openbaar Bestuur en Overheid</SelectItem>
  <SelectItem value="verkeer-en-infrastructuur">Verkeer en Infrastructuur</SelectItem>
  <SelectItem value="wonen-en-vastgoed">Wonen en Vastgoed</SelectItem>
